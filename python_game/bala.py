...
class Bala:
    def __init__(self, x, y, vel, lado):
        ...
        self._x = x
        self._y = y
        self._ancho = self._alto = lado     # siempre van a ser cuadrados
        self._velocidad = vel
        self._color = "white"
        self._rect = pygame.Rect(self._x, self._y, self._ancho, self._alto) # cambia las coordenadas
        self._imagen = pygame.image.load("media/bullet.png") # cargar imagen del personaje
    ...
    def movimiento(self):
        # mueve instancias de Enemigo hacia ARRIBA
